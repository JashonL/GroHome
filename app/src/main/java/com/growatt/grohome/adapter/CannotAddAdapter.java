...
public class CannotAddAdapter extends BaseQuickAdapter<GroDeviceBean, BaseViewHolder> {


    public CannotAddAdapter(int layoutResId, @Nullable List<GroDeviceBean> data) {
        super(layoutResId, data);
    }

    public CannotAddAdapter(@Nullable List<GroDeviceBean> data) {
        super(data);
    }

    public CannotAddAdapter(int layoutResId) {
        super(layoutResId);
    }
