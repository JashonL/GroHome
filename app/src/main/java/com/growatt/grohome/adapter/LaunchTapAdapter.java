...
public class LaunchTapAdapter extends BaseMultiItemQuickAdapter<ScenesBean.DataBean, BaseViewHolder> {


    public LaunchTapAdapter(@Nullable List<ScenesBean.DataBean> data) {
        super(data);
        addItemType(GlobalConstant.STATUS_ON, R.layout.item_launch_tap_to_run);
        addItemType(GlobalConstant.STATUS_OFF, R.layout.item_launch_tap_to_run_off);
    }
