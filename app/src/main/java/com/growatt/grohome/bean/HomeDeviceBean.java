...
public class HomeDeviceBean {
    ...
    public static class DataBean implements MultiItemEntity {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof HomeDeviceBean.DataBean)) throw new ClassCastException("类型错误");
            HomeDeviceBean.DataBean p = (HomeDeviceBean.DataBean) obj;
