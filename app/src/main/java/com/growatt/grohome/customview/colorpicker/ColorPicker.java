...
public class ColorPicker extends View {
    ...
    /**
     *
     * {@code true} if the user clicked on the pointer to start the move mode. <br>如果用户单击指针以启动移动模式。
     * {@code false} once the user stops touching the screen.  一旦用户停止触摸屏幕。
     *
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mColorCenterRadius = a.getDimensionPixelSize(
                ...
                b.getDimensionPixelSize(R.dimen.dp_54));
        ...
        mColorCenterHaloRadius = a.getDimensionPixelSize(
                ...
                b.getDimensionPixelSize(R.dimen.dp_60));
