...
public class RoomEditPresenter extends BasePresenter<IRoomEditView> {
    ...
    public void transferDevice(String deviceId, String deviceType) {
        CircleDialogUtils.showCommentDialog((FragmentActivity) context, context.getString(R.string.m208_note), context.getString(R.string.m305_transfer_device), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
